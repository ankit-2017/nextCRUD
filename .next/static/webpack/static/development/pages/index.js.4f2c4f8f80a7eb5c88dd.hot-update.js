...
function (_Component) {
  ...
  _createClass(Home, [{
    ...
    value: function render() {
      console.return(react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
        __source: {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                data = store.dispatch(this.props.insert_data());
                return _context.abrupt("return", {
                  data: data // store.dispatch(insert_data());
...
//# sourceMappingURL=index.js.4f2c4f8f80a7eb5c88dd.hot-update.js.map