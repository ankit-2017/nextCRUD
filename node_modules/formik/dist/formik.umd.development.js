        ...
        _this.handleSubmit = function (e) {
          ...
          if (typeof document !== 'undefined') {
            ...
            if (activeElement !== null && activeElement instanceof HTMLButtonElement) {
              warning_1(!!(activeElement.attributes && activeElement.attributes.getNamedItem('type')), 'You submitted a Formik form using a button with an unspecified `type` attribute.  Most browsers default button elements to `type="submit"`. If this is not a submit button, please add `type="button"`.');
            }
          }
